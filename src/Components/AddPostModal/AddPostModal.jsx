                ...
                <Modal.Dialog centered size="lg" backdrop="static">
                    ...
                    <Modal.Body>
                        <form onSubmit={submitForm}>
                            <div className='my-2'><input style={{ borderRadius: '5px' }} placeholder='category' type="text" onChange={(e) => setCategory(e.target.value)} /></div>
                            <div className='my-2'><input style={{ borderRadius: '5px' }} placeholder='title' type="text" onChange={(e) => setTitle(e.target.value)} /></div>
                            <div className='my-2'><input placeholder='cover' type="file" onChange={handleFileChange} /></div>
