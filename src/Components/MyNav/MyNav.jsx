...
const MyNav = () => {
  ...
  const [isDarkTheme, setIsDarkTheme] = useState(actualTheme); 
    ...
    >
      <Container className='container'>
        ...
        <Navbar.Toggle aria-controls="navbarScroll">
          <CgMenuRightAlt style={{ fontSize: '2rem' }} />
        </Navbar.Toggle>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          <Form className="d-flex align-items-center">
            ...
            {isDarkTheme ? (
              <IoMoonSharp className='dark' style={{ fontSize: '1.5rem' }} onClick={() => selectTheme()} />
            ) : (
              <IoSunnySharp className='light' style={{ fontSize: '1.5rem' }} onClick={() => selectTheme()} />
            )}
          </Form>
        </Navbar.Collapse>
      </Container>
