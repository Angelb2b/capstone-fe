...
const SingleComment = (comment) => {
    ...
    const isModeratorOrBelardo = session.role === 'moderator' || session.email === 'belardo.ang@gmail.com';

    return (
        <Card className={`comment-card ${actualTheme ? '' : 'dark-theme'}`}>
